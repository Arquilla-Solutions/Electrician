    ...
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-blue-100">
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-4">
          ...
          {[
            ...
            <div key={key}>
              <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase tracking-wide">
                {label}{" "}
                {key !== "email" && <span style={{ color: YELLOW }}>*</span>}
              </label>
              <input
                type={type}
                ...
                required={key !== "email"}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition"
              />
            </div>
          ))}
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase tracking-wide">
              How can we help? <span style={{ color: YELLOW }}>*</span>
            </label>
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-lg text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition resize-none"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-4 sm:py-5 rounded-lg font-extrabold text-base hover:brightness-110 transition-all tracking-widest shadow-lg uppercase disabled:opacity-70"
          >
